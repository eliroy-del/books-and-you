-- Catalog: Golden History of Ghana BS 3 (NaCCA Primary History)
...
select
  'golden-history-of-ghana-bs-3',
  'Golden History of Ghana BS 3',
  'Based on the New NaCCA Syllabus',
  'Golden History of Ghana BS 3 is a primary school history textbook based on the new NaCCA syllabus. It introduces Basic 3 learners to Ghana''s story, people, and national life through clear lessons and classroom activities.',
  'Aligned with the National Council for Curriculum and Assessment (NaCCA) syllabus for Primary School. This Golden series title helps Basic 3 pupils explore the history of Ghana with age-appropriate content.',
  '978-9988-2-6903-3',
  144,
  'English',
  '2024-01-01',
  p.id,
  '/covers/golden-history-of-ghana-bs-3/front.jpg',
  'from-[#15803D] via-[#FACC15] to-[#EA580C]',
  '#DC2626',
  array['History','Primary 3','Textbooks','NaCCA'],
  array['Our Community','People of Ghana','Independence','National Life'],
  true,
  true,
  jsonb_build_object('series','Golden','level','BS 3','curriculum','NaCCA','subject','History')
...
where b.slug = 'golden-history-of-ghana-bs-3'
...
select b.id, t.tag
from public.books b
cross join (values ('history'), ('primary-3'), ('nacca'), ('golden'), ('textbook'), ('ghana')) as t(tag)
where b.slug = 'golden-history-of-ghana-bs-3'
on conflict do nothing;

delete from public.book_images
where book_id = (select id from public.books where slug = 'golden-history-of-ghana-bs-3');
...
cross join (
  values
    ('/covers/golden-history-of-ghana-bs-3/front.jpg', 'Golden History of Ghana BS 3 front cover', 0, true),
    ('/covers/golden-history-of-ghana-bs-3/angle.jpg', 'Golden History of Ghana BS 3 angled view', 1, false)
