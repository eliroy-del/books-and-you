-- Catalog: History of Ghana for Basic Schools Book 2 (Masterman / 2019 Curriculum)
...
select
  'history-of-ghana-for-basic-schools-book-2',
  'History of Ghana for Basic Schools',
  'Book 2 · Based on the 2019 New Curriculum',
  ...
  '2020-01-01',
  p.id,
  '/covers/history-of-ghana-for-basic-schools-book-2/front.jpg',
  'from-[#DC2626] via-[#EF4444] to-[#7F1D1D]',
  '#FACC15',
  array['History','Primary 2','Textbooks','Curriculum'],
  array['Our Community','People Around Us','National Life','Everyday History'],
  true,
  true,
  jsonb_build_object('series','Masterman','level','Book 2','curriculum','2019 New Curriculum','subject','History')
...
where b.slug = 'history-of-ghana-for-basic-schools-book-2'
...
where b.slug = 'history-of-ghana-for-basic-schools-book-2'
  and c.slug in ('primary-school', 'primary-history', 'level-primary-2')
...
select b.id, t.tag
from public.books b
cross join (values ('history'), ('primary-2'), ('curriculum'), ('masterman'), ('textbook'), ('ghana')) as t(tag)
where b.slug = 'history-of-ghana-for-basic-schools-book-2'
on conflict do nothing;

delete from public.book_images
where book_id = (select id from public.books where slug = 'history-of-ghana-for-basic-schools-book-2');
...
cross join (
  values
    ('/covers/history-of-ghana-for-basic-schools-book-2/front.jpg', 'History of Ghana for Basic Schools Book 2 front cover', 0, true),
    ('/covers/history-of-ghana-for-basic-schools-book-2/angle.jpg', 'History of Ghana for Basic Schools Book 2 angled view', 1, false)
