-- Catalog: Golden Our World Our People KG 2
...
select
  'golden-our-world-our-people-kg-2',
  'Golden Our World Our People KG 2',
  ...
  '2024-01-01',
  p.id,
  '/covers/golden-our-world-our-people-kg-2/front.jpg',
  ...
  true,
  true,
  jsonb_build_object('series','Golden','level','KG 2','subject','Our World Our People','curriculum','NaCCA')
...
where b.slug = 'golden-our-world-our-people-kg-2'
...
select b.id, t.tag
from public.books b
cross join (values ('owop'), ('our-world-our-people'), ('kindergarten'), ('kg-2'), ('golden'), ('nacca'), ('ghana')) as t(tag)
where b.slug = 'golden-our-world-our-people-kg-2'
on conflict do nothing;

delete from public.book_images
where book_id = (select id from public.books where slug = 'golden-our-world-our-people-kg-2');
...
cross join (
  values
    ('/covers/golden-our-world-our-people-kg-2/front.jpg', 'Golden Our World Our People KG 2 front cover', 0, true)
