-- Catalog: History of Ghana for Basic Schools Book 3 (Masterman / 2019 Curriculum)
...
select
  'history-of-ghana-for-basic-schools-book-3',
  'History of Ghana for Basic Schools',
  'Book 3 · Based on the 2019 New Curriculum',
  'History of Ghana for Basic Schools Book 3 from Masterman Publications is aligned with the 2019 new curriculum. It develops Basic 3 learners'' understanding of Ghana''s history through clear lessons and classroom activities.',
  'Published by Masterman Publications Ltd. This Book 3 title supports primary learners with curriculum-based history content on Ghana''s people, places, and national life.',
  '978-9988-3-8203-0',
  136,
  'English',
  '2020-01-01',
  p.id,
  '/covers/history-of-ghana-for-basic-schools-book-3/front.jpg',
  'from-[#15803D] via-[#22C55E] to-[#14532D]',
  '#FACC15',
  array['History','Primary 3','Textbooks','Curriculum'],
  array['Our Community','People of Ghana','National Life','Everyday History'],
  true,
  true,
  jsonb_build_object('series','Masterman','level','Book 3','curriculum','2019 New Curriculum','subject','History')
...
where b.slug = 'history-of-ghana-for-basic-schools-book-3'
...
where b.slug = 'history-of-ghana-for-basic-schools-book-3'
  and c.slug in ('primary-school', 'primary-history', 'level-primary-3')
...
select b.id, t.tag
from public.books b
cross join (values ('history'), ('primary-3'), ('curriculum'), ('masterman'), ('textbook'), ('ghana')) as t(tag)
where b.slug = 'history-of-ghana-for-basic-schools-book-3'
on conflict do nothing;

delete from public.book_images
where book_id = (select id from public.books where slug = 'history-of-ghana-for-basic-schools-book-3');
...
cross join (
  values
    ('/covers/history-of-ghana-for-basic-schools-book-3/front.jpg', 'History of Ghana for Basic Schools Book 3 front cover', 0, true),
    ('/covers/history-of-ghana-for-basic-schools-book-3/angle.jpg', 'History of Ghana for Basic Schools Book 3 angled view', 1, false)
