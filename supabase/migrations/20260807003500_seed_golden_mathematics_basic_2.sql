-- Catalog: Golden Mathematics for Basic Schools 2 (NaCCA Primary Maths)
...
select
  'golden-mathematics-basic-2',
  'Golden Mathematics for Basic Schools 2',
  ...
  '2024-01-01',
  p.id,
  '/covers/golden-mathematics-basic-2/front.jpg',
  'from-[#FACC15] via-[#EF4444] to-[#F97316]',
  '#DC2626',
  array['Mathematics','Primary 2','Textbooks','NaCCA'],
  array['Numbers','Shapes','Fractions','Problem Solving'],
  true,
  true,
  jsonb_build_object('series','Golden','level','Basic 2','curriculum','NaCCA','subject','Mathematics')
...
where b.slug = 'golden-mathematics-basic-2'
...
select b.id, t.tag
from public.books b
cross join (values ('mathematics'), ('primary-2'), ('nacca'), ('golden'), ('textbook'), ('ghana')) as t(tag)
where b.slug = 'golden-mathematics-basic-2'
on conflict do nothing;

delete from public.book_images
where book_id = (select id from public.books where slug = 'golden-mathematics-basic-2');
...
cross join (
  values
    ('/covers/golden-mathematics-basic-2/front.jpg', 'Golden Mathematics for Basic Schools 2 front cover', 0, true),
    ('/covers/golden-mathematics-basic-2/angle.jpg', 'Golden Mathematics for Basic Schools 2 angled view', 1, false)
