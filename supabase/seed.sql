...
-- Publishers
insert into public.publishers (id, slug, name, country, description) values ('4c4c291f-fde9-4fb0-a594-2088395b0d3e', 'sub-saharan', 'Sub-Saharan Publishers', 'Ghana', 'Sub-Saharan Publishers — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('998e188c-d29c-45b8-a74a-cf8390558c47', 'heinemann', 'Heinemann', 'UK', 'Heinemann — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('07fd5cec-beb2-45d4-ab0f-ad2be65580d3', 'cassava', 'Cassava Republic', 'Nigeria', 'Cassava Republic — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('5f4f9543-7660-45d4-a99a-726bc98748f1', 'penguin', 'Penguin Random House', 'USA', 'Penguin Random House — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('02ae7c3c-b4b2-4478-a7e1-748be5a1428f', 'knopf', 'Alfred A. Knopf', 'USA', 'Alfred A. Knopf — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('24cc4918-b75f-4e3b-a96f-4e696d0ff9f6', 'harvard', 'Harvard University Press', 'USA', 'Harvard University Press — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('826b81ec-1c6a-4acd-a251-8aa287bfcdb2', 'woeli', 'Woeli Publishing', 'Ghana', 'Woeli Publishing — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('55e6a204-c370-46a1-a692-ff30de70289e', 'afram', 'Afram Publications', 'Ghana', 'Afram Publications — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('ed2d4b94-722c-4c72-a595-16c0d1a7be5c', 'vintage', 'Vintage Books', 'UK', 'Vintage Books — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('5603d67e-fde0-4bd3-a3bc-47907b4fabc1', 'faber', 'Faber & Faber', 'UK', 'Faber & Faber — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('54d242a5-d81e-474f-a7f9-6ea8d4aead22', 'oxford', 'Oxford University Press', 'UK', 'Oxford University Press — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('a73de719-f474-47b3-a869-87de7255a175', 'macmillan', 'Macmillan', 'USA', 'Macmillan — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('251b66ad-4cc7-4af5-a62b-6f9f731e54c9', 'bloomsbury', 'Bloomsbury', 'UK', 'Bloomsbury — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('c2b92780-f3ce-4f42-af6b-60aaac4559ec', 'spectacle', 'Spectacle Press Accra', 'Ghana', 'Spectacle Press Accra — trusted publisher') on conflict (slug) do update set name = excluded.name;
insert into public.publishers (id, slug, name, country, description) values ('e2af66e0-e1ba-4fcb-af24-a67afe617f4c', 'sahara', 'Sahara Books', 'Ghana', 'Sahara Books — trusted publisher') on conflict (slug) do update set name = excluded.name;
